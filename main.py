...
def encrypt_help():
	...
	print("python main.py --encrypt -p 79 -a 30 -B 59 -m 44 -vv")
	sys.exit(1)


def decrypt_help():
	print("Incorrect arguments. Example:")
	print("python main.py --decrypt -p 79 -a 30 -b 61 -m 73 -ke 13 -vv")
	sys.exit(1)


def sign_help():
	print("Incorrect arguments. Example:")
	print("python main.py --sign -p 541 -a 128 -b 105 -m 95 -vv")
	sys.exit(1)


def verify_help():
	print("Incorrect arguments. Example:")
	print("python main.py --verify -p 541 -a 128 -B 239 -m 95 -r 280 -s 65 -vv")
	sys.exit(1)
